class AppMenu {
    ...
    constructor () {
        ...
        // Menu buttons
        let nav_resource = document.getElementById("nav_resource");
        let nav_display = document.getElementById("nav_display");
        let nav_convertor = document.getElementById("nav_convertor");
        
        // Fragments
        let displayprop_fragment = document.getElementById("displayprop_fragment");
        let rescalc_fragment = document.getElementById("rescalc_fragment");
        let convertor_fragment = document.getElementById("convertor_fragment");
